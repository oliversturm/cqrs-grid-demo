// Using jQuery for ajax - there would be another way in Angular,
// but for consistency in this project, and since jQuery is required
// by the DevExtreme widgets anyway, I decided to keep the logic
// the same as for the other UI frontends.
